  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        fit: StackFit.expand,
        children: [
          // 1. Luminous Fluid Sapphire-Indigo Gradient Background
          AnimatedBuilder(
              ...
              return Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      Color.lerp(
                        const Color(0xFF0C244A),
                        const Color(0xFF143B70),
                        t,
                      )!,
                      Color.lerp(
                        const Color(0xFF164882),
                        const Color(0xFF0F315E),
                        t,
                      )!,
                      Color.lerp(
                        const Color(0xFF0E548A),
                        const Color(0xFF1B62A3),
                        t,
                      )!,
                      Color.lerp(
                        const Color(0xFF0A1D3B),
                        const Color(0xFF0E2D57),
                        t,
                      )!,
                    ],
          ...
          // 2. Top-Left Floating Cyan Glow Orb
          AnimatedBuilder(
            animation: _bgAnimationController,
            builder: (context, child) {
              final t = _bgAnimationController.value;
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      colors: [
                        const Color(0xFF00F0FF).withValues(alpha: 0.32),
                        const Color(0xFF1D6FFF).withValues(alpha: 0.16),
                        Colors.transparent,
                      ],
          ...
          AnimatedBuilder(
            ...
            builder: (context, child) {
              final t = _bgAnimationController.value;
              final pulseOpacity = 0.28 + (t * 0.14);
              ...
              return Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      colors: [
                        const Color(0xFF00D2FF).withValues(alpha: pulseOpacity),
                        const Color(
                          0xFF1D6FFF,
                        ).withValues(alpha: pulseOpacity * 0.5),
                        Colors.transparent,
                      ],
          ...
          // 4. Bottom-Right Floating Royal Blue Glow Orb
          AnimatedBuilder(
            animation: _bgAnimationController,
            builder: (context, child) {
              final t = _bgAnimationController.value;
              ...
              return Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      colors: [
                        const Color(0xFF1D6FFF).withValues(alpha: 0.30),
    ...
    for (int i = 0; i < _basePoints.length; i++) {
      ...
      final paint = Paint()
        ..color = (i % 3 == 0)
            ...
            : const Color(0xFF1D6FFF).withValues(alpha: alpha * 0.85)
