...
import '../../../dummy/dummy_completed_deliveries.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const AppSearchBar(hint: "Search Completed Deliveries..."),
                  const SizedBox(height: 25),
                  Expanded(
                    child: ListView.builder(
                      itemCount: dummyCompletedDeliveries.length,
                      itemBuilder: (context, index) {
                        return CompletedDeliveryCard(
                          delivery: dummyCompletedDeliveries[index],
                          onViewReceipt: () {},
                        );
                      },
                    ),
