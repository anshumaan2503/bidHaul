        ...
        if (showSubtitle) ...[
          ...
          Text(
            ...
            style: GoogleFonts.inter(
              ...
              letterSpacing: 2.8,
              color: subtitleColor ?? const Color(0xFF8AD2EA).withValues(alpha: 0.90),
            ),
          ),
        ],
        if (showGetStarted) ...[
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              ...
              BoxShadow(
                color: const Color(0xFF1D6FFF).withValues(alpha: 0.35),
                blurRadius: 12,
                spreadRadius: 0,
